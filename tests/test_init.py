...
from custom_components.knmi_seismisch.const import DOMAIN, PLATFORMS
...
@pytest.mark.asyncio
async def test_async_setup_entry_with_cache(hass: HomeAssistant, mock_coordinator_setup):
